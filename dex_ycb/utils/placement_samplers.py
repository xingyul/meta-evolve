...
from utils.transform_utils import quat_multiply
from models.objects import MujocoObject
...
class SequentialCompositeSampler(ObjectPositionSampler):
    ...
    def append_sampler(self, sampler, sample_args=None):
        ...
        for obj in sampler.mujoco_objects:
            assert obj not in self.mujoco_objects, "Object '{obj.name}' already has sampler associated with it!"
            self.mujoco_objects.append(obj)
