...
from models.base import MujocoModel
...
class MujocoEnv(metaclass=EnvMeta):
    ...
    def _reset_internal(self):
        ...
        if self.has_renderer and self.viewer is None:
            ...
            self.viewer.viewer.cam.azimuth = 180
            self.viewer.viewer.cam.lookat[:] = np.array([-0.4, 0, 0.4])
            self.viewer.viewer.cam.distance = 2
