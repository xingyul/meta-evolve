...
from environments.manipulation.manipulation_env import ManipulationEnv
from utils.robot_utils import check_bimanual
from utils.transform_utils import mat2quat
...
class TwoArmEnv(ManipulationEnv):
    ...
    def _check_robot_configuration(self, robots):
        ...
        if self.env_configuration == "single-arm-opposed" or self.env_configuration == "single-arm-parallel" or self.env_configuration == "single-arm-cornered":
