...
from models.objects import CompositeObject
from utils.mjcf_utils import array_to_string, add_to_dict
from utils.mjcf_utils import RED, GREEN, BLUE, CustomMaterial
        ...
        for i, (g_list, handle_side, rgba) in enumerate(zip(
            ...
            if self.solid_handle:
                ...
                add_to_dict(
                    ...
                    geom_materials="handle{i}_mat" if self.use_texture else None,
            ...
            self._important_sites["handle{i}"] = self.naming_prefix + handle_name
