"""
Gripper with two fingers for Adroit Robots.
"""
import numpy as np
from utils.mjcf_utils import xml_path_completion
from models.grippers.gripper_model import GripperModel


class AdroitGripperBase(GripperModel):
    """
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/adroit_gripper.xml"), idn=idn)
...
class AdroitGripper(AdroitGripperBase):
    """
