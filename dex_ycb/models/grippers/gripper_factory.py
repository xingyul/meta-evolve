...
def gripper_factory(name, idn=0):
    ...
    from models.grippers import GRIPPER_MAPPING, ALL_GRIPPERS

    # Make sure gripper is valid
    assert name in GRIPPER_MAPPING, "Unknown gripper name: {}. Valid options are: {}".format(name, ALL_GRIPPERS)
