import numpy as np
from models.robots.manipulators.manipulator_model import ManipulatorModel
from utils.mjcf_utils import xml_path_completion


class Adroit(ManipulatorModel):
    """
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("robots/adroit/robot.xml"), idn=idn)
