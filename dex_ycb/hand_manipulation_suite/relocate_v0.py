...
class RelocateEnvV0(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def reset_model(self, seed=None):
        ...
        self.model.site_pos[self.target_obj_sid, 0] = np.random.uniform(low=-0.2, high=0.2)
        self.model.site_pos[self.target_obj_sid,1] = np.random.uniform(low=-0.2, high=0.2)
