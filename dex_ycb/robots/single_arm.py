...
from utils.buffers import DeltaBuffer, RingBuffer
...
class SingleArm(Manipulator):
    ...
    def setup_observables(self):
        ...
        names = ["{}eef_pos".format(pf), "{}eef_quat".format(pf)]
        ...
        if self.has_gripper:
            ...
            names += ["{}gripper_qpos".format(pf), "{}gripper_qvel".format(pf)]
